...
public class AccountManager {
    ...
    public void creditMoney(long account_number) throws Exception {
        sc.nextLine();
        ...
        try {
            ...
            if (account_number != 0) {
                ...
                if (resultSet.next()) {
                    String creditQuery = "UPDATE accounts SET balance = balance + ? WHERE security_pin = ?";
    ...
    public void debitMoney(long account_number) throws Exception {
        sc.nextLine();
        System.out.print("Enter Amount: ");
        double amount = sc.nextDouble();
        sc.nextLine();
    ...
    public void transferMoney(long sender_account_number) throws Exception {
        sc.nextLine();
